...
def command(message):
    ...
    bot.send_sticker(chat_id, 'CAACAgQAAxkBAAIB6GKV4f4OkqRu_Avwp4fs3Nzvx6JLAAK_EQACpvFxHq2xh5JRVJNrJAQ')
    ...
    users_file = open(str(user_name) + ".txt", 'w')
...
def send_help(bot, chat_id):
    bot.send_message(chat_id, "Автор: Панферова Юлия")
    markup = types.InlineKeyboardMarkup()
    btn1 = types.InlineKeyboardButton(text="Напишите автору", url="https://t.me/kooooooov")
    markup.add(btn1)
