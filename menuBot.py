...
m_fun = Menu("Развлечения", buttons=["Прислать собаку", "Прислать лису", "Прислать анекдот", "Прислать фильм", "Угадай кто?", 'Орел или решка', 'Узнать правду', 'Agario', "Выход"], parent=m_main, module="fun")
